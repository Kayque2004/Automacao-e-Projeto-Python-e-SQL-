### Python + SQL
### conxacão de bancos de dados
### nao esquece de instalar o pyodbc
...
dadoConexao = ("Driver={SQLite3 ODBC Driver};Server=localhost;Database=C:\\trabalho\\Python SQL\Projeto_Compras.db")
